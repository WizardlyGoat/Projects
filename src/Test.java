...
public class Test
{
	...
	{
		// white pieces
		pieces[0].setPosition ( Square.removed ); // Rook
		pieces[1].setPosition ( Square.removed ); // Knight
		pieces[2].setPosition ( Square.removed ); // Bishop
		pieces[3].setPosition ( Square.removed ); // Queen
		// pieces[4].setPosition ( Square.removed ); // King
		pieces[5].setPosition ( Square.removed ); // Bishop
		pieces[6].setPosition ( Square.removed ); // Knight
		// pieces[7].setPosition ( Square.removed ); // Rook
		for ( int i = 8; i < 16; i++ )
		{
			// pieces[i].setPosition ( Square.removed ); // Pawns
		}
		// black pieces
		pieces[16].setPosition ( Square.removed ); // Rook
		pieces[17].setPosition ( Square.removed ); // Knight
		pieces[18].setPosition ( Square.removed ); // Bishop
		pieces[19].setPosition ( Square.removed ); // Queen
		// pieces[20].setPosition ( Square.removed ); // King
		pieces[21].setPosition ( Square.removed ); // Bishop
		pieces[22].setPosition ( Square.removed ); // Knight
		// pieces[23].setPosition ( Square.removed ); // Rook
		for ( int i = 24; i < 32; i++ )
		{
			// pieces[i].setPosition ( Square.removed ); // Pawns
		}
	 ...
	 * 
	 * @param before
	 *           the point standing before a move is tested
	 * @param after
	 *           the point standing after a move is tested
	 * @return nothing
	 */
	...
	/******************************************************************************
	 * printPositionScores prints each player's total position scores and outputs the difference
	 * 
	 * @param pieces
	...
	/******************************************************************************
	 * printObservationScores prints each player's total position scores and outputs the difference
	 * 
	 * @param pieces
	 *           the array of all the pieces
	 * @return nothing
	...
	/******************************************************************************
	 * printPointWorths prints each player's total position scores and outputs the difference
	 * 
	 * @param pieces
	 *           the array of all the pieces
	 * @return nothing
	 ...
	 * 
	 * @param moves
	 *           the arrayList of ComputerMoves
	 */
	 ...
	 * 
	 * @param move
	 *           the ComputerMove that needs to be printed
	 */
	 ...
	 * 
	 * @param moves
	 *           the arrayList of Piece arrays (positions)
	 */
