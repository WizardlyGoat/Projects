...
public class ChessDriver extends Application
{
	...
	public void start( Stage primaryStage )
	{
		...
		for ( int r = 1; r < 9; r++ )
		{
			// int reverseRow = Math.abs ( r - 8 ) + 1; // get the correct column (reverse of c)
			...
			// GridPane.setConstraints ( labelPane, 0, r ); // position the border pane within the grid pane
			labelPane.setId ( "0" + r );
		...
		for ( int c = 1; c < 9; c++ )
		{
			...
			// GridPane.setConstraints ( labelPane, c, 9 ); // position the border pane within the grid pane
			labelPane.setId ( c + "" + 9 );
			boardGrid.getChildren ( ).add ( labelPane ); // add the border pane to the board
		}
	 ...
	 * 
	 * @param end
	 *           the message saying how the game ended
	 * @return nothing
	 */
	 ...
	 * 
	 * @param position
	 *           the position of the piece in string form
	 * @param imagePath
	 *           the imagePath for the new image
	 * @return nothing
	 */
	 ...
	 * @param destination
	 *           the piece's destination square
	 * @return nothing
	 */
	...
	/******************************************************************************
	 * clearLegalMoveEffects clears all effects and resets the color of given rectangle
	 * 
	 * @param rec
	 *           the rectangle being reset
	 * @return nothing
	 */
	...
	/******************************************************************************
	 * clearPastMoveEffects clears all effects and resets the color of given rectangle
	 * 
	 * @param rec
	 *           the rectangle being reset
	 * @return nothing
	...
	/****************************************************************************
	 * getRecAtPosition returns the rectangle from the stack pane with the Id position
	 * 
	 * @param position
	 *           the Id of the stack pane being searched for
	 * @return nothing
	 */
	...
	/*********************************************************************************
	 * addStartingPieces adds each starting piece to the GUI on their correct squares
	 * 
	 * @param pieces
	 *           the array of all pieces
	 * @return nothing
	 */
	public static void addStartingPieces( Piece[ ] pieces )
	{
		...
		{
			position = pieces[i].getPosition ( ).getStringPosition ( );
			...
			if ( pane != null )
			{
				...
				{
					// get the image
					image = new Image ( new FileInputStream ( pieces[i].getImagePath ( ) ) );
	...
	/************************************************************************************
	 * setPerspective sets constraints on each node in boardRoot according to playerTurn
	 * 
	 * @param playerTurn
	 *           the player's turn (white or black)
	 * @return nothing
