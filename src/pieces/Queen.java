...
public class Queen extends Piece {
	 ...
	 * is on
	 * 
	 * @param currSquare the square that the piece is considering moving to
	...
	public double getPieceHesitation(StandardGame game, ComputerMove currMove, ComSettings difficulty) {
		...
		if (turn < difficulty.getQueenHesitateTillTurn()) {
			...
			hesitation += (difficulty.getQueenPerTurnHesitation() * (turn - difficulty.getQueenHesitateTillTurn()));
		}
